...
│                        2. Planner 阶段                           │
│  ┌─────────────┐                                                   │
│  │ Planner     │ → 生成策略计划，确定多维度生成方向                    │
│  │   Agent     │ → 技术栈、项目类型、复杂度分布                      │
│  └─────────────┘                                                   │
└─────────────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────────────┐
│                        3. Executor 阶段                          │
│  ┌─────────────┐                                                   │
│  │ Executor    │ → 基于主题生成多个候选 Idea                         │
│  │   Agent     │ → 每个 Idea 包含：标题、描述、功能、技术栈等         │
│  └─────────────┘                                                   │
└─────────────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────────────┐
│                        4. Critic 阶段                            │
│  ┌─────────────┐                                                   │
│  │ Critic      │ → 评估每个 Idea 的可行性、创新性、商业价值           │
│  │   Agent     │ → 淘汰不符合要求的 Idea                            │
│  └─────────────┘                                                   │
└─────────────────────────────────────────────────────────────────┘
                          ↓
...
**更新日期**: 2026-04-15
**状态**: 设计阶段
**变更**: 新增 Idea 生成流程（手动触发），用户可输入主题自动生成 Idea，或手动添加 Idea
